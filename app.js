...
var age;
age = "i am 22 year old";
alert(age);
var visit;
visit = " you have visited this site 14 times";
alert(visit)
var birthYear;
birthYear = "My birth year is 1998 <br> my decleared variable is number"
...
var KE,customer,billMonth,numUnit,chrgePerUnit,netAmount,latePay,grossAmount;
    customer = "Mohammad Hamza Kashif"
    billMonth = "June"
    numUnit = 200
    chrgePerUnit = 16
...
//     return -1;                       
// }
// console.log(indexingOf("siraj is an software engineer", "Y"))
// console.log(indexingOf("siraj is an software engineer", "e"))
// console.log(indexingOf("siraj is an software engineer", "t"))
...
// var text = "My name is siraj and i am an software engineer";
// var a = remVowel(text)
// remVowel(text)
...
// task 2
{/* <div>
    <img src="imgs/img 1.JPG" onClick="alert('Thanks for purchasing the phone from us')" >
        <img src="imgs/img 2.JPG" onClick="alert('Thanks for purchasing the phone from us')" >
            <img src="imgs/img 3.JPG" onClick="alert('Thanks for purchasing the phone from us')" >
                <img src="imgs/img 4.JPG" onClick="alert('Thanks for purchasing the phone from us');" >
                     </div> */}
...
{/* <table>
    <thead>
        ...
        <tr>
            ...
            <th>Jhone</th>
            <th>10</th>
            <th><button onclick="SomeDeleteRowFunction(this)">Delete</button></th>
        </tr>
        <tr>
            <th>1</th>
            <th>Doe</th>
...
// task 4
{/* <img src="imgs/img 1.JPG" onMouseover="src='imgs/img 2.JPG'" onmouseout="src='imgs/img 1.JPG'"></img> */ }
...
{/* <p>Clicks: <a id="clicks">0</a></p>
    <button type="button" onClick="increaser()">Increase</button>
    <button type="button" onClick="decreaser()">Decrease</button> */}
...
eMail.value = "hamzakashif990@hotmail.com";
